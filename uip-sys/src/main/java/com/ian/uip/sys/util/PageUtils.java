...
public final class PageUtils {
    ...
    public static <T> Page<T> pageQOToPage(PageQO pageQO) {
        return formatPage(pageQO.getPage(), pageQO.getRows(), pageQO.getSort(), pageQO.getOrder(), true);
    }

    public static <T> Page<T> pageQOToPageNoChange(PageQO pageQO) {
        return formatPage(pageQO.getPage(), pageQO.getRows(), pageQO.getSort(), pageQO.getOrder(), false);
    }
